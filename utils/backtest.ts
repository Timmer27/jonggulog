...
// import * as transformCandle from "./transformCandle";
...
type Strategy = (
  candleIndex: number,
  candle: Candle,
  positionTypes: PositionTypesEnum,
...
class Backtest {
  ...
  public calculateIndicators(): void {
    this.indicatorsSettings.forEach((indicator) => {
      ...
      this.indicators[indicatorKey] =
        this.indicators[indicatorKey].concat(calculatedIndicator);
    });
  }
  ...
  public closePosition({ isStopLossHit, isTakeProfitHit }): void {
    ...
    this.state.positionType = PositionTypesEnum.NONE;
  ...
  public openPosition(price, positionType = positionTypes.LONG): void {
    ...
    this.state.positionType = PositionTypesEnum.LONG;
  }
  ...
  public start(): State {
    ...
    this.candles.forEach((candle: Candle, candleIndex: number) => {
      ...
      this.strategy(candleIndex, candle, PositionTypesEnum.NONE, OrderTypesEnum.LIMIT);
