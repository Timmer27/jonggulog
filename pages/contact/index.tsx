...
export default function Contact({}) {
  ...
  const submitContactHandler = () => {
    ...
    if (textValue === "") {
      ...
      axios.post("/api/contact", {type: selectedValue, content: textValue}).then((res) => {
  ...
  return (
    <div className="mt-20 mb-10 lg:w-[68%] md:w-[68%] sm:w-[90%] m-auto shadow-[0px_0px_5px_0px_#d4d4d4] rounded-xl bg-clip-border h-fit p-[3rem_1rem]">
      ...
      <form className="">
        <div className="flex flex-col gap-6 mb-1">
          ...
          <div className="relative w-full min-w-[200px] min-h-[10rem] h-56">
            <textarea
              ref={textRef}
              placeholder="문의사항을 적어주세요 (최대 3000자)"
              maxLength={2999}
